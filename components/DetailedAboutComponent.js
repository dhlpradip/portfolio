    ...
    return ( 
        ...
        <div className="max-h-4xl bg-blend-overlay " style={{maxHeight:'60rem'}}>
            ...
            <div className="text-justify text-2xl max-w-6xl">
                ...
                <p>So, My name is Pradeep Dahal. I originally come from the eastern hills of Nepal, currently looking for the purpose and meaning of life in this city of dreams, Kathmandu.</p>
                ...
                <p>Apart from the self obsession above, I love poetry and can kill for a good poem. I love to listen any kind of music, mainly HipHop, and I'm a sucker for books, memes and a little on the dark side of jokes. </p>
            </div>
            <div className="mt-20">
            </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            <div className="">
                ...
                {userData.techStack.map((item, i)=>(
                    <div  key={i}>
                        <p className="border border-gray-600 p-2 m-2 text-xl">{item}</p>
                    </div>
                ))}
                </div>
            </div>
        ...
        <p className="text-5xl font-bold mb-12">Education</p>
          <VerticalTimeline animate={true}>
            {userData.education.map((item, i)=>(
              ...
              key={i}
              // date={item.duration}
              contentStyle={{backgroundColor: "#262620",border: true, borderColor: 'gray'}}
              iconStyle={{ backgroundColor:'black' ,color: '#fff' }}
              icon={<MdSchool />}
              >
              <h3 className="text-gray-300 font-bold text-2xl">{item.school}</h3>
