const userData = {
    ...
    techStack: ["HTML5", "CSS3","JavaScript", "React", "NextJS", "React Native", "Redux", "TailwindCSS", "Bootstrap", "C", "C++", "Python"],
    otherSkills: ["Good interpersonal skill", "Values other's efforts", "Can lead a team well", "Can communicate in multiple language","Understands and appreciate good humor", "Sarcastic"],
    education:[
      {
