...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Architecture",
        paragraphs: [
          "It's an npm-workspaces monorepo: a React/Vite course UI, an Express grading server, and a shared package of exercise specs. Your submission is loaded into a sandboxed child process, the grader boots it as a live Express app, then fires declarative test specs at it, covering method, path, expected status, JSON assertions, and header checks.",
  ...
  },
  {
    ...
    tagline:
      "An 18-day interactive FastAPI bootcamp with a databases arc covering raw SQL, SQLAlchemy, MongoDB, and Docker, with every exercise graded automatically.",
    year: "2026",
    stack: [
      "Python",
      "FastAPI",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "It deliberately shares no code with Express Academy, with the grader specs, runner, and client rebuilt Python-first, but the two run side by side on different ports, so you can work through both stacks in parallel.",
        ],
      },
      {
  ...
  },
  {
    ...
    tagline:
      "An 18-day interactive NestJS bootcamp covering decorators, modules, providers, guards, pipes, interceptors, TypeORM, and JWT auth, with every exercise auto-graded by a NestJS grader that is itself meta-proof the framework works.",
    year: "2026",
    stack: [
      "NestJS",
      "TypeScript",
    ...
    sections: [
      ...
      },
      {
        heading: "Architecture",
        paragraphs: [
          "The platform is an npm-workspaces monorepo: a React/Vite course UI, a NestJS grading server, and a shared package of exercise specs. Writing the grader itself in NestJS was a deliberate choice, because it means every deployment proves the framework works the way the lessons claim.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Tests support a declarative DSL: expected status codes, deep-subset JSON assertions, bodyContains string checks, and a save/interpolate mechanism that chains requests, so a create-endpoint captures an ID and the next test uses it in a GET path. This chaining was essential for the TypeORM and JWT days where exercises build on earlier state.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Each arc mirrors the same trajectory in Express and FastAPI academies, letting a student compare how the three frameworks handle the same problems, routing, validation, persistence, and auth, side by side.",
        ],
      },
      {
    ...
    sections: [
      {
        heading: "The problem",
        paragraphs: [
          "Every AI coding tool demands its own instruction file: Claude Code reads CLAUDE.md, Cursor wants .mdc rules, Copilot has copilot-instructions.md, Windsurf and Aider have their own formats. Keep them all by hand and they drift apart within a week, so the guidance your assistants follow depends on which editor you happened to open.",
    ...
    sections: [
      {
        heading: "The context",
        paragraphs: [
          "For my M.Sc. in Intelligent Systems, I had to present the practical issues of neural network training, drawing the material from Goodfellow, Bengio, and Courville's Deep Learning. I could have made slides. But the whole point of these failure modes is how they behave, and behavior is exactly what static slides can't show.",
      ...
      },
      {
        heading: "Decisions and trade-offs",
        paragraphs: [
          "The entire site is a single self-contained index.html, with no build step, no framework, no dependencies. That was a presentation-day constraint turned feature: it opens from a file:// URL, survives a venue with no Wi-Fi, and will still render unchanged in a decade.",
        ],
      },
      {
        heading: "Outcome",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Since discoverability was the entire point, it ships proper sitemap and robots metadata routes, so someone searching for their constituency should land here.",
        ],
      },
      {
        heading: "Decisions and trade-offs",
  ...
  },
  {
    ...
    tagline:
      "A digital mixtape postcard, where you pick songs from YouTube, write a note, and share a link that opens as an animated card with a cassette illustration and built-in player.",
    year: "2026",
    stack: [
      "Next.js 16",
      "TypeScript",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Every element is designed to feel warm and human, with cream paper tones, soft gradients, a script font for the greeting, and a light blue background that mimics a desk surface. The cursor-driven cover shadow is a small detail that makes the card feel physical.",
